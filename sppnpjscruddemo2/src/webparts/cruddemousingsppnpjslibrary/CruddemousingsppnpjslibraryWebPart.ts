...
import styles from './CruddemousingsppnpjslibraryWebPart.module.scss';
import * as strings from 'CruddemousingsppnpjslibraryWebPartStrings';

export interface ICruddemousingsppnpjslibraryWebPartProps {
  description: string;
}

export default class CruddemousingsppnpjslibraryWebPart extends BaseClientSideWebPart<ICruddemousingsppnpjslibraryWebPartProps> {
  public render(): void {
